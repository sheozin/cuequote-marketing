  ...
  -H "Authorization: Bearer $CUEQUOTE_API_KEY"`}</Code>
        ...
        <div style={{ marginTop: 56, padding: 24, background: "#f0fdf4", border: "1px solid #a7f3d0", borderRadius: 14 }}>
          ...
          <p style={{ ...P, marginBottom: 0 }}>
            The <a href="/docs/widget" style={{ color: "#10b981", fontWeight: 600 }}>website quote form</a> puts this same engine on your own site with one script tag. Webhooks and Zapier are on the roadmap.

...
export default async function PricingPage() {
  ...
  const comparisonRows = [
    ...
    { label: t("compRiskAssessment", { defaultValue: "Risk assessment" }), free: false, starter: t("compBasic", { defaultValue: "Basic" }), pro: t("compFull", { defaultValue: "Full" }), business: t("compFull", { defaultValue: "Full" }) },

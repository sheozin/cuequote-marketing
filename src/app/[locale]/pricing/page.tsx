...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: 'CueQuote',
      type: 'website',
      images: [{ url: `https://cuequote.com${localePath}${pagePath}/opengraph-image`, width: 1200, height: 630, alt: title }],
    },
    twitter: {
      ...
      description,
      site: '@cuequote',
      images: [`https://cuequote.com${localePath}${pagePath}/opengraph-image`],
    },
  };
}
...
export default async function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: [t("starterF1"), t("starterF2"), t("starterF3"), t("starterF4"), t("starterF5"), t("starterF6"), t("starterF7")],
      cta: t("startTrial"),
  ...
  const comparisonRows = [
    ...
    { label: t("compRiskAssessment", { defaultValue: "Full risk assessment (8 categories)" }), free: false, starter: t("compBasic", { defaultValue: "Basic" }), pro: t("compFull", { defaultValue: "Full" }), business: t("compFull", { defaultValue: "Full" }) },
    ...
    { label: t("compInventory", { defaultValue: "Inventory management" }), free: t("comp10Units", { defaultValue: "10 units" }), starter: t("comp50Units", { defaultValue: "50 units" }), pro: t("compUnlimited", { defaultValue: "Unlimited" }), business: t("compUnlimited", { defaultValue: "Unlimited" }) },
    { label: t("compCrewManagement", { defaultValue: "Crew management" }), free: t("comp5Members", { defaultValue: "5 members" }), starter: t("comp20Members", { defaultValue: "20 members" }), pro: t("compUnlimited", { defaultValue: "Unlimited" }), business: t("compUnlimited", { defaultValue: "Unlimited" }) },

...
export const TUTORIALS_PL: Tutorial[] = [
  ...
  },
  {
    ...
    mode: 'av',
    whatYouLearn: [
      'Wybór sztuk śledzonych lub trybu zbiorczego dla każdej pozycji katalogu',
      'Konfiguracja inwentarza: liczba sztuk, wklejone numery seryjne lub import CSV',
    ...
    steps: [
      {
        title: 'Wybierz, jak śledzić każdą pozycję',
        content: 'Otwórz katalog i edytuj pozycję, którą posiadasz. W polu Śledzenie inwentarza wybierz „Sztuki śledzone, jedna etykieta na sztukę” dla sprzętu, który chcesz śledzić egzemplarz po egzemplarzu, np. mikrofonów, projektorów czy głów ruchomych: każda sztuka dostaje własny numer ewidencyjny i etykietę QR. Wybierz „Zbiorczo, jedna etykieta i ilość” dla rzeczy, które liczysz, a nie śledzisz, np. kabli czy obejm. Ekipa, transport i usługi pozostają nieśledzone.',
        tip: 'Śledź to, czego kiedyś będziesz szukać. Jeśli zapytasz, która sztuka wróciła uszkodzona, śledź sztuki.',
      },
      {
        title: 'Uruchom kreator konfiguracji',
        content: 'Przejdź do Inwentarza z paska bocznego i kliknij „Skonfiguruj inwentarz”. Krok 1, „Co posiadasz?”: zaznacz posiadane pozycje katalogu i ustaw prefiks numeru ewidencyjnego. Numery wyglądają jak INV-00001, chyba że wybierzesz własny prefiks. Krok 2, „Ile sztuk każdej pozycji?”: wpisz liczbę sztuk albo wklej numery seryjne, jeden na wiersz, aby utworzyć jedną sztukę na numer. Krok 3 drukuje etykiety.',
        tip: 'Prefiks dotyczy tylko nowych sztuk, więc ustal go przed utworzeniem pierwszych.',
      },
      {
        title: 'Dodawaj sztuki później lub zaimportuj arkusz',
        content: 'Kliknij „Dodaj sztuki” na stronie Inwentarza, wybierz sprzęt i wpisz liczbę albo wklej numery seryjne. Aby wczytać listę, którą już prowadzisz, użyj „Importuj z arkusza (CSV)” z kolumnami equipment, serial, purchase_date (RRRR-MM-DD), purchase_price i code. Sprzęt musi odpowiadać pozycji katalogu ustawionej na sztuki śledzone; niepasujące wiersze są pomijane i wypisywane, żeby można je było poprawić.',
      },
      {
        title: 'Wydrukuj etykiety QR',
        content: 'Kliknij „Drukuj etykiety” i wybierz rozmiar: arkusze A4 z etykietami 70 × 37 mm (24 na arkuszu), 48,5 × 25,4 mm (40 na arkuszu) lub 99,1 × 38,1 mm (14 na arkuszu), niestandardowy arkusz A4, w którym podajesz rozmiar etykiety, kolumny, wiersze i odstępy, albo rolkę 62 × 29 mm lub 50 × 25 mm. CueQuote tworzy PDF, który wydrukujesz na każdej drukarce. Na częściowo zużytym arkuszu użyj „Zacznij od pozycji”, aby pominąć wykorzystane etykiety.',
        tip: 'Najpierw wydrukuj jedną stronę na zwykłym papierze i przyłóż ją do arkusza etykiet, aby sprawdzić dopasowanie.',
      },
      {
        title: 'Zarządzaj sztuką',
        content: 'Kliknij dowolną sztukę, aby otworzyć jej stronę: numer ewidencyjny, numer seryjny, dane zakupu, stan techniczny i status (Dostępna, W naprawie, Zagubiona lub Wycofana). Użyj „Oznacz jako uszkodzoną”, „Wyślij do naprawy” i „Wróciła z naprawy”, „Oznacz jako zagubioną” i „Oznacz jako odnalezioną” albo „Wycofaj”. Każda zmiana trafia do historii sztuki, z notatką, jeśli ją dodasz. W sekcji „Inne kody na tej sztuce” dodaj stare naklejki lub kody kreskowe producenta, które mają prowadzić do tej samej sztuki.',
        tip: 'Wycofanie jest trwałe: sztuka na zawsze opuszcza stan, a jej numer nigdy nie zostanie użyty ponownie. Historia zostaje.',
      },
      {
        title: 'Co się dzieje po zeskanowaniu etykiety',

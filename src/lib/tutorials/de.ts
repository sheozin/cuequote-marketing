...
export const TUTORIALS_DE: Tutorial[] = [
  ...
  },
  {
    ...
    mode: 'av',
    whatYouLearn: [
      'Erfasste Einheiten oder Sammelposten für jeden Katalogartikel wählen',
      'Inventar einrichten: mit Stückzahlen, eingefügten Seriennummern oder CSV-Import',
    ...
    steps: [
      {
        title: 'Festlegen, wie jeder Artikel erfasst wird',
        content: 'Öffnen Sie Ihren Katalog und bearbeiten Sie einen Artikel, den Sie besitzen. Wählen Sie unter Inventarerfassung „Erfasste Einheiten, je ein Etikett“ für Technik, die Sie Stück für Stück verfolgen wollen, etwa Mikrofone, Projektoren oder Moving Heads: Jede Einheit erhält eine eigene Anlagennummer und ein QR-Etikett. Wählen Sie „Sammelposten, ein Etikett und eine Menge“ für Dinge, die Sie zählen statt verfolgen, etwa Kabel oder Schellen. Crew, Transport und Dienstleistungen bleiben nicht erfasst.',
        tip: 'Erfassen Sie, was Sie je wiederfinden müssen. Wenn Sie fragen würden, welches Exemplar beschädigt zurückkam, erfassen Sie die Einheiten.',
      },
      {
        title: 'Den Einrichtungsassistenten starten',
        content: 'Öffnen Sie Inventar in der Seitenleiste und klicken Sie auf „Inventar einrichten“. Schritt 1, „Was besitzen Sie?“: Markieren Sie die Katalogartikel, die Sie besitzen, und legen Sie das Präfix der Anlagennummer fest. Nummern sehen aus wie INV-00001, sofern Sie kein eigenes Präfix wählen. Schritt 2, „Wie viele von jedem?“: Geben Sie für jeden erfassten Artikel eine Anzahl ein oder fügen Sie Seriennummern ein, eine pro Zeile, um je Seriennummer eine Einheit anzulegen. Schritt 3 druckt die Etiketten.',
        tip: 'Das Präfix gilt nur für neue Einheiten. Legen Sie es daher fest, bevor Sie die ersten Einheiten anlegen.',
      },
      {
        title: 'Später Einheiten hinzufügen oder eine Tabelle importieren',
        content: 'Klicken Sie auf der Inventarseite auf „Einheiten hinzufügen“, wählen Sie das Gerät und geben Sie eine Anzahl ein oder fügen Sie Seriennummern ein. Um eine vorhandene Liste zu übernehmen, nutzen Sie „Aus Tabelle importieren (CSV)“ mit den Spalten equipment, serial, purchase_date (JJJJ-MM-TT), purchase_price und code. Das Gerät muss einem Katalogartikel entsprechen, der auf erfasste Einheiten eingestellt ist; nicht passende Zeilen werden übersprungen und aufgelistet, damit Sie sie korrigieren können.',
      },
      {
        title: 'QR-Etiketten drucken',
        content: 'Klicken Sie auf „Etiketten drucken“ und wählen Sie eine Etikettengröße: A4-Bögen mit 70 × 37 mm (24 pro Bogen), 48,5 × 25,4 mm (40 pro Bogen) oder 99,1 × 38,1 mm (14 pro Bogen), einen benutzerdefinierten A4-Bogen mit eigener Etikettengröße, Spalten, Zeilen und Abständen, oder eine Etikettenrolle mit 62 × 29 mm oder 50 × 25 mm. CueQuote erstellt ein PDF, das auf jedem Drucker druckt. Bei einem angebrochenen Bogen überspringen Sie mit „An Position beginnen“ die bereits verwendeten Etiketten.',
        tip: 'Drucken Sie zuerst eine Seite auf normalem Papier und halten Sie sie gegen Ihren Etikettenbogen, um die Ausrichtung zu prüfen.',
      },
      {
        title: 'Eine Einheit verwalten',
        content: 'Klicken Sie auf eine Einheit, um ihre Seite zu öffnen: Anlagennummer, Seriennummer, Kaufdaten, Zustand und Status (Verfügbar, In Reparatur, Verloren oder Ausgemustert). Nutzen Sie „Als beschädigt markieren“, „Zur Reparatur schicken“ und „Aus der Reparatur zurück“, „Als verloren markieren“ und „Als gefunden markieren“ oder „Ausmustern“. Jede Änderung landet im Verlauf der Einheit, mit einer Notiz, wenn Sie eine schreiben. Unter „Weitere Codes auf dieser Einheit“ ergänzen Sie alte Aufkleber oder Hersteller-Barcodes, die dieselbe Einheit finden sollen.',
        tip: 'Ausmustern ist endgültig: Die Einheit verlässt Ihren Bestand, und ihre Anlagennummer wird nie wieder vergeben. Der Verlauf bleibt erhalten.',
      },
      {
        title: 'Was beim Scannen eines Etiketts passiert',

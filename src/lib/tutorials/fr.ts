...
export const TUTORIALS_FR: Tutorial[] = [
  ...
  },
  {
    ...
    mode: 'av',
    whatYouLearn: [
      'Choisir unités suivies ou lot pour chaque article du catalogue',
      'Configurer l\'inventaire : quantités, numéros de série collés ou import CSV',
    ...
    steps: [
      {
        title: 'Choisir comment suivre chaque article',
        content: 'Ouvrez votre catalogue et modifiez un article que vous possédez. Dans Suivi de l\'inventaire, choisissez « Unités suivies, une étiquette chacune » pour le matériel que vous voulez suivre pièce par pièce, comme les micros, projecteurs vidéo ou lyres : chaque unité reçoit son propre numéro d\'inventaire et son étiquette QR. Choisissez « Lot, une étiquette et une quantité » pour ce que vous comptez sans le suivre, comme les câbles ou les colliers. L\'équipe, le transport et les services restent non suivis.',
        tip: 'Suivez ce que vous aurez un jour besoin de retrouver. Si vous vous demanderiez laquelle est revenue abîmée, suivez les unités.',
      },
      {
        title: 'Lancer l\'assistant de configuration',
        content: 'Ouvrez Inventaire dans la barre latérale et cliquez sur « Configurer l\'inventaire ». Étape 1, « Que possédez-vous ? » : cochez les articles du catalogue que vous possédez et définissez le préfixe du numéro d\'inventaire. Les numéros ressemblent à INV-00001, sauf si vous choisissez votre propre préfixe. Étape 2, « Combien de chaque ? » : saisissez une quantité pour chaque article suivi, ou collez des numéros de série, un par ligne, pour créer une unité par numéro. L\'étape 3 imprime les étiquettes.',
        tip: 'Le préfixe ne s\'applique qu\'aux nouvelles unités : fixez-le avant de créer les premières.',
      },
      {
        title: 'Ajouter des unités plus tard, ou importer un tableur',
        content: 'Cliquez sur « Ajouter des unités » dans la page Inventaire, choisissez l\'équipement et indiquez une quantité ou collez des numéros de série. Pour reprendre une liste existante, utilisez « Importer depuis un tableur (CSV) » avec les colonnes equipment, serial, purchase_date (AAAA-MM-JJ), purchase_price et code. L\'équipement doit correspondre à un article du catalogue réglé sur unités suivies ; les lignes sans correspondance sont ignorées et listées pour que vous puissiez les corriger.',
      },
      {
        title: 'Imprimer les étiquettes QR',
        content: 'Cliquez sur « Imprimer les étiquettes » et choisissez un format : feuilles A4 de 70 × 37 mm (24 par feuille), 48,5 × 25,4 mm (40 par feuille) ou 99,1 × 38,1 mm (14 par feuille), une feuille A4 personnalisée où vous indiquez la taille, les colonnes, les lignes et les espacements, ou un rouleau de 62 × 29 mm ou 50 × 25 mm. CueQuote crée un PDF imprimable sur n\'importe quelle imprimante. Sur une feuille entamée, utilisez « Commencer à la position » pour sauter les étiquettes déjà utilisées.',
        tip: 'Imprimez d\'abord une page sur du papier ordinaire et posez-la sur votre feuille d\'étiquettes pour vérifier l\'alignement.',
      },
      {
        title: 'Gérer une unité',
        content: 'Cliquez sur une unité pour ouvrir sa page : numéro d\'inventaire, numéro de série, données d\'achat, état et statut (Disponible, En réparation, Perdu ou Retiré). Utilisez « Marquer comme endommagée », « Envoyer en réparation » et « Retour de réparation », « Marquer comme perdue » et « Marquer comme retrouvée », ou « Retirer ». Chaque changement s\'ajoute à l\'historique de l\'unité, avec une note si vous en écrivez une. Dans « Autres codes sur cette unité », ajoutez les anciens autocollants ou codes-barres fabricant qui doivent retrouver la même unité.',
        tip: 'Le retrait est définitif : l\'unité quitte votre stock et son numéro d\'inventaire n\'est jamais réutilisé. Son historique est conservé.',
      },
      {
        title: 'Ce qui se passe quand on scanne une étiquette',

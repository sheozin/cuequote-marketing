...
export const TUTORIALS_EN: Tutorial[] = [
  ...
  },
  {
    ...
    videoUrl: '',
    whatYouLearn: [
      'Choosing tracked units or bulk for each catalog item',
      'Setting up inventory with counts, pasted serial numbers or a CSV import',
    ...
    steps: [
      {
        title: 'Choose how each item is tracked',
        content: 'Open your catalog and edit an item you own. Under Inventory tracking, choose "Tracked units, one label each" for gear you want to follow piece by piece, such as microphones, projectors or moving heads: every unit gets its own asset number and QR label. Choose "Bulk, one label and a quantity" for things you count rather than follow, such as cables or clamps. Crew, transport and services stay not tracked.',
        tip: 'Track what you would ever need to find again. If you would ask which one came back damaged, track the units.',
      },
      {
        title: 'Run the setup wizard',
        content: 'Go to Inventory from the sidebar and click "Set up inventory". Step 1, "What do you own?": mark the catalog items you own and set your asset number prefix. Numbers look like INV-00001 unless you choose your own prefix. Step 2, "How many of each?": enter a count for each tracked item, or paste serial numbers one per line to create one unit per serial. Step 3 prints the labels.',
        tip: 'The prefix applies to new units only, so settle it before you create your first units.',
      },
      {
        title: 'Add units later, or import a spreadsheet',
        content: 'Click "Add units" on the Inventory page, choose the equipment, and enter how many or paste serial numbers. To bring in a list you already keep, use "Import from spreadsheet (CSV)" with the columns equipment, serial, purchase_date (YYYY-MM-DD), purchase_price and code. The equipment must match a catalog item set to tracked units; rows that do not match are skipped and listed so you can fix them.',
      },
      {
        title: 'Print QR labels',
        content: 'Click "Print labels" and pick a label size: A4 sheets of 70 × 37 mm (24 per sheet), 48.5 × 25.4 mm (40 per sheet) or 99.1 × 38.1 mm (14 per sheet), a custom A4 sheet where you enter the label size, columns, rows and gaps, or a label roll of 62 × 29 mm or 50 × 25 mm. CueQuote creates a PDF you can print on any printer. On a partly used sheet, use "Start at position" to skip the labels already used.',
        tip: 'Print one page on plain paper first and hold it against your label sheet to check the alignment.',
      },
      {
        title: 'Look after a unit',
        content: 'Click any unit to open its page: asset number, serial number, purchase details, condition and status (Available, In repair, Lost or Retired). Use "Mark damaged", "Send to repair" and "Back from repair", "Mark lost" and "Mark found", or "Retire". Every change is added to the unit\'s history, with a note if you write one. Under "Other codes on this unit", add old sticker codes or manufacturer barcodes that should find the same unit.',
        tip: 'Retiring is permanent: the unit leaves your stock for good and its asset number is never reused. Its history stays.',
      },
      {
        title: 'What happens when a label is scanned',
